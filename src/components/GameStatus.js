...
class GameStatus extends Component {
  ...
  render() {
    return (
      <div>
        <div onClick={this.props.clickBlue}>Blue</div>
        <div onClick={this.props.clickGreen}>Green</div>
        <div onClick={this.props.clickYellow}>Yellow</div>
        <div onClick={this.props.clickRed}>Red</div>
        <div onClick={this.props.comparePlays}>Compare</div>
        <div onClick={this.props.startGame}>Start the Game</div>
     </div>
      )
  }
...
// = ( {clickBlue, clickGreen, clickYellow, clickRed, comparePlays, startGame} ) => {
//   return (
//     <div>
